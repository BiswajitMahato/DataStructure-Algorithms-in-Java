...
public class EggDropProblemBU {
    ...
    public static void main(String[] args) {
        EggDropProblemBU eggDP = new EggDropProblemBU();
        int eggs = 2;
        int floors = 100;
        System.out.printf("(DP) Minimum number of drops required in worst case with eggs: %s and floors: %s is : %s",eggs,floors,eggDP.getDrops(eggs,floors));
    }
