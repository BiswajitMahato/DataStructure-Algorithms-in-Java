 ...
 * Problem Statement : You are being given an integer array named my_array, you need to find the sum of elements between indices i and j(i<=j)
 *                     , inclusive. Note that there are many such queries that you need to answer.
 *
 *
 */
...
// Initializing sumUntil array globally with a large integer value
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Query 3> sumRange(3,3) is equal to: " + sor.sumOfRange(3, 3));
